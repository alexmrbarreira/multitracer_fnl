...
from pylab import *
import pylab
#from scipy import interpolate, integrate, optimize, ndimage, special
#from numpy import linalg, random
#from collections import Counter
#from decimal import Decimal
rcParams.update({'text.usetex': True, 'mathtext.fontset': 'stix'}) #['dejavuserif', 'cm', 'custom', 'stix', 'stixsans', 'dejavusans']

## ======================================================================
## General parameters
## ======================================================================
lpath = '/home/barreira/a.Other/d-github_workrepos/d-primordial_universe_multitracer/'
...
numfac_matter = h**2./(2./5./Om0/H0**2.) # Multiply matter transfer function data from CAMB by numfac_matter to get transfer function in (km/s)^2/h^2 and with definition delta_m(k,z) = 2/(5 Omega_m H0^2) * k^2 * R(k) * T_m(k)
